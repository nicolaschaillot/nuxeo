 ...
 * @since 11.1
 */
@Operation(id = RetainDocument.ID, category = Constants.CAT_DOCUMENT, label = "Retain", description = "Turn the input document into a record and retain it until the given date. Returns back the retained document.")
